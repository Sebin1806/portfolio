        ...
        <ScrollReveal animation="blur-in">
          <div className="flex flex-col items-center text-center mb-10">
            <h2 className="text-3xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-100 flex items-center justify-center gap-3">
              <span className="text-rose-500 font-mono text-2xl sm:text-4xl md:text-5xl font-bold">06.</span>
              ...
              {filteredCerts.map((cert: Certificate, index: number) => {
                return (
                  ...
                  >
                    ...
                    <div className="w-full h-full bg-slate-900/95 border border-slate-800 hover:border-slate-700 p-2.5 sm:p-3 flex flex-col justify-between rounded-2xl relative shadow-lg hover:shadow-xl hover:shadow-black/40 transition-all duration-300">
                      
                      {/* Top Accent Gradient Bar */}
                      <div className="absolute top-0 left-0 right-0 h-1 bg-rose-500 rounded-t-2xl" />

                      {/* Certificate Image Thumbnail */}
                      <div className="w-full h-20 sm:h-24 rounded-xl overflow-hidden border border-slate-800 relative bg-slate-950 shadow-inner group-hover:scale-[1.02] transition-transform duration-300 shrink-0 flex items-center justify-center p-0.5">
                        {cert.image ? (
                          <img
                            src={cert.image}
                            alt={cert.title}
                        ...
                        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                          <span className="px-3 py-1.5 rounded-lg bg-slate-900/90 text-white text-[11px] font-semibold backdrop-blur-md border border-slate-700 flex items-center gap-1.5 shadow-lg">
                            <Eye className="w-3.5 h-3.5 text-rose-400" /> View Certificate
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="text-left mt-2">
                        <h4 className="text-xs sm:text-sm font-bold text-slate-100 group-hover:text-rose-400 line-clamp-2 leading-tight transition-colors">
                          {cert.title}
                        </h4>
                        <p className="text-[10px] font-mono text-rose-400/90 mt-1 flex items-center justify-between">
                      ...
                      {/* Action Footer */}
                      <div className="pt-2 border-t border-slate-800 flex items-center justify-between gap-1 text-[10px] font-mono text-slate-300">
                        ...
                        <a
                          ...
                          className="btn-red-custom flex items-center gap-1 px-3 py-1 text-[11px] shadow-sm cursor-pointer"
                        >
