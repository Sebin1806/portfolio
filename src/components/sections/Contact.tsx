...
const contactCards = [
  { Icon: Mail, label: "EMAIL", id: "sebinsebin180606@gmail.com", href: "mailto:sebinsebin180606@gmail.com" },
  { Icon: Phone, label: "PHONE", id: "+91 93428 13276", href: "tel:+919342813276" },
  { Icon: Github, label: "GITHUB", id: "Sebin1806", href: "https://github.com/Sebin1806" },
  { Icon: Linkedin, label: "LINKEDIN", id: "Sebin S", href: "https://www.linkedin.com/in/sebin-s-098bb62ab/" },
  { Icon: Code2, label: "LEETCODE", id: "Sebin_S", href: "https://leetcode.com/u/Sebin_S/" },
];
              ...
              <div className="relative z-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="relative">
                    ...
                    <Input type="email" placeholder="Email Address" value={email} onChange={(e) => setEmail(e.target.value)} maxLength={255}
                      className="pl-11 py-6 rounded-2xl bg-background/50 border-border/40 text-foreground placeholder:text-muted-foreground focus:border-primary/40 focus:ring-primary/20 transition-all" />
                  </div>
                  <Textarea placeholder="Message" value={message} onChange={(e) => setMessage(e.target.value)} maxLength={1000} rows={5}
                  ...
                  <button type="submit" disabled={sending}
                    className="group w-full flex items-center justify-center text-xl font-inherit text-primary-foreground py-[0.7em] px-[1em] border-none rounded-2xl overflow-hidden transition-all duration-200 cursor-pointer active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
