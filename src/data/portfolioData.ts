...
export const JOURNEY: JourneyNode[] = [
  {
    ...
    period: 'Schooling',
    type: 'root',
    description: 'Built a strong foundation in Mathematics, Physics, and Computer Science. Discovered passion for logic and computer programming.',
    achievements: ['Excellence in Mathematics & Science', 'Discovered fascination with computing'],
    icon: 'school'
  },
  {
    id: 'programming-interest',
    title: 'Discovered Programming & Python',
    subtitle: 'Beginning the Developer Journey',
    institution: 'Self-Driven Learning',
    location: 'Kanniyakumari',
    period: 'Early Spark',
    type: 'milestone',
    description: 'Began writing first Python scripts, understanding control structures, algorithms, and logic puzzles. Realized the magic of turning code into intelligent actions.',
    achievements: ['Mastered Python Fundamentals', 'Built small utility scripts'],
    icon: 'code'
  },
  {
    id: 'college',
    title: 'Joined B.Tech AI & Data Science',
    subtitle: 'Undergraduate Degree',
    institution: 'V.S.B. College of Engineering Technical Campus',
    location: 'Coimbatore, Tamil Nadu',
    period: '2023 - Present (2023-2027 Batch)',
    type: 'education',
    description: 'Enrolled in specialized Artificial Intelligence & Data Science degree. Immersed in Data Structures, Machine Learning algorithms, Statistics, and Database Systems.',
    achievements: ['Consistently strong academic performance', 'Active member of AI student organization'],
    icon: 'graduation-cap'
  },
  {
    id: 'ml-breakthrough',
    title: 'Built First Machine Learning Projects',
    subtitle: 'Email Spam Shield & ML Algorithms',
    institution: 'V.S.B. College of Engineering Technical Campus',
    location: 'Coimbatore',
    period: '2024',
    type: 'project',
    description: 'Applied supervised learning techniques to text classification. Designed Email Spam Shield using TF-IDF and Naive Bayes classifiers to filter spam in real-time.',
  ...
  },
  {
    ...
    subtitle: 'Retrieval-Augmented Generation & Healthcare Bot',
    institution: 'Hands-on Projects & Certifications',
    location: 'Coimbatore',
    period: '2024 - 2025',
    type: 'project',
    description: 'Spearheaded Generative AI exploration. Engineered a RAG Chatbot using vector databases and LLMs alongside an AI Healthcare Chatbot for intelligent medical guidance.',
    achievements: ['Built end-to-end vector search pipelines', 'Integrated custom knowledge embeddings'],
    icon: 'sparkles'
  },
  {
    id: 'crewai-multiagent',
    title: 'Multi-Agent AI Systems with CrewAI',
    subtitle: 'Autonomous Agentic Collaborations',
    institution: 'Advanced AI Development',
    location: 'Coimbatore',
    period: '2025',
    type: 'project',
    description: 'Pioneered multi-agent data analysis workflows. Orchestrated specialized AI agents (Analyst, Researcher, Reporter) working in sync to produce automated dataset insights.',
    achievements: ['Built autonomous multi-agent pipeline', 'Automated complex data summarization'],
    icon: 'network'
  },
  {
    id: 'final-year',
    title: 'Final Year Student & Future AI Engineer',
    subtitle: 'Ready to Impact top Tech & AI Teams',
    institution: 'V.S.B. College & Beyond',
    location: 'Open to Relocation',
    period: 'Present (2023-2027 Batch)',
    type: 'future',
    description: 'Currently preparing for graduation. Actively seeking Internship and Full-Time AI/ML/Data Engineering roles at leading tech enterprises and high-growth AI startups.',
    achievements: ['4+ Full-stack AI projects ready', 'Certified across AWS, Python, AI & PowerBI'],
    icon: 'rocket'
  }
];
...
export const CERTIFICATES: Certificate[] = [
  {
    ...
    category: 'Research',
    credentialId: 'IJCRT Vol. 12 Issue 11',
    verifyUrl: 'https://ijcrt.org',
    downloadUrl: '#',
    previewColor: 'from-purple-500/20 to-indigo-600/20',
    skillsCovered: ['Cyber Security', 'Research Journal', 'IJCRT', 'Threat Analysis'],
    image: '/research-ijcrt-cert.jpg'
  },
  {
    id: 'cert-patent-smart-dustbin',
    title: 'Smart Dustbin System with Automated Dust Collection & IoT Integration',
    issuer: 'Patent Office Journal (App No: 202541009764 A)',
    issueDate: 'February 2025',
    category: 'Patent',
    credentialId: '202541009764 A',
    verifyUrl: 'https://ipindia.gov.in',
    downloadUrl: '#',
    previewColor: 'from-amber-500/20 to-orange-600/20',
    skillsCovered: ['Official Patent', 'IoT Integration', 'Smart City', 'Waste Management', 'Automation'],
